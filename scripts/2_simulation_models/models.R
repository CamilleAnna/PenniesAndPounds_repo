#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
#                         Pound&Pennies paper                          #
#         Model functions sourced in "simulations.R" script            #
#                        Last edit 24/07/2021                          #
#                          Camille Simonet                             #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #

# MODEL BRIEF SUMMARY ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# All models describe the dynamic for two drugs, a front-line drug and a las-line drugs
# people are treated with the front-line drug then escalated (at rate a) to last-line drug if infection does not clear
# Population is a two-class population: carriers (C) and symptomatics (I)
# Infections transmits differently between (bb) and within (bw) classes
# And drug usage differs between the two classes: only front-line drug used in carrier class
# Assortative transmission + diffential usage generates coexistence of multiple strains
# + usage of drug in carrier class represents bystander selection
#  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# New drug on market
# (single set of equations. Front-line or last-line deployment implemented by setting initial conditions appropriately)
...
# Function used to measure integral over quantities in model output
