#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
#                         Pound&Pennies paper                          #
#       Script to plot dynamics out of any simulation output script
#        Very rough plot but with all parameter values etc. on it
#               For informative & exploratory purpose
...
# setwd(path/to/repo)
setwd('~/Documents/PhD/Research/Pennies_and_Pounds/')
setwd('./3_output/model_output/simulations_output_samples/')
...
pdf('~/Documents/PhD/Research/Pennies_and_Pounds/3_output/figures_and_tables/figures_parts/dynamics_example.pdf', width = 9.5, height = 7.5)
